	...
	export default {
		data() {
			return {
				...
				ruleForm: {},
				user: {},
				heads: {"headLogoutFontHoverColor":"#dce8f6","headFontSize":"20px","headUserInfoFontColor":"#4a5f79","headBoxShadow":"0 8px 20px rgba(38, 58, 84, 0.16)","headTitleImgHeight":"44px","headLogoutFontHoverBgColor":"#3b516f","headFontColor":"#2f3f53","headTitleImg":false,"headHeight":"60px","headTitleImgBorderRadius":"22px","headTitleImgUrl":"http://codegen.caihongy.cn/20201021/cc7d45d9c8164b58b18351764eba9be1.jpg","headBgColor":"#eef3f9","headTitleImgBoxShadow":"0 4px 12px rgba(52, 79, 115, 0.2)","headLogoutFontColor":"#4a5f79","headUserInfoFontSize":"16px","headTitleImgWidth":"44px","headTitleStyle":"2","headLogoutFontSize":"16px"},
			};
		},
		created() {
			this.setHeaderStyle()
	...
	.navbar {
		...
		.title-menu {
			...
			.title-img {
				...
				height: 44px;
				border-radius: 22px;
				box-shadow: 0 4px 12px rgba(52, 79, 115, 0.22);
				margin-right: 16px;
			}
